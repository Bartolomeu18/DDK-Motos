...
<div class="max-w-6xl mx-auto px-4 py-8 ">
    ...
    <div class="bg-blue-600 rounded-md p-11 w-2/3 text-white text-md font-bold shadow-lg shadow-gray-300">
        <h2>{{$motoqueiros }}  Motoqueiros</h2>
    </div>
    <div class="bg-red-600 rounded-md p-11 w-2/3 text-white text-md font-bold shadow-lg shadow-gray-300">
        <h2>{{$motorizadas}}  Motorizadas</h2>
    </div>
        <div class="bg-green-600 rounded-md p-11 w-2/3 text-white text-md font-bold shadow-lg shadow-gray-300">
        <h2>{{$Agente}}  Agentes</h2>
    </div>
    </div>
 <h2 class="text-2xl font-bold text-red-600 mb-3 text-left pt-8">Minhas Informações</h2>
      <!-- Tabela de usuários -->
    <div class="overflow-x-auto bg-white shadow rounded-lg  mt-10">
