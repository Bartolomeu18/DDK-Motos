...
<div class="max-w-7xl mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold text-red-600 mb-6 text-left">Gestão de ADMIN</h2>
    ...
    <form method="GET" action="" class="mb-6">
        ...
        <div class="flex items-center space-x-2">
            <input type="text" name="search" value="{{ request('search') }}"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 shadow-lg shadow-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
