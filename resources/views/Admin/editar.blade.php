...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="w-full max-w-lg bg-white rounded-lg shadow-md p-6 m-10">
        <div class="text-center mb-6">
            ...
            <h2 class="text-2xl font-bold text-red-600">Cadastro Administrador</h2>
...
@endif
        ...
        <form method="post" action="{{ route('Admin.update',['id'=>$id]) }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" required value="{{old('name',$userData->name)}}"
            ...
            <div class="mb-4">
                ...
                <input type="email" name="email" id="email" value="{{old('email',$userData->email)}}" required
                       class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="telefone" id="telefone" value="{{old('telefone',$userData->telefone)}}" required
                       class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="bi_passaporte" id="bi_passaporte" value="{{old('bi_passaporte',$userData->bi_passaporte)}}" required
                       class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="endereco" id="endereco" value="{{old('endereco',$userData->endereco)}}" required
                       class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
            </div>
