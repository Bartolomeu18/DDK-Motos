...
@section('content')
<div class="max-w-7xl mx-auto px-4 py-8 ml-10">
    <h2 class="text-2xl font-bold text-red-600 mb-6 text-left">Gestão de Motorizadas</h2>
    ...
    <tr>
        ...
        <th class="px-6 py-3 text-left text-sm font-medium text-white">Matrícula</th>
        <th class="px-6 py-3 text-left text-sm font-medium text-white">Ano</th>
        <th class="px-6 py-3 text-left text-sm font-medium text-white">Cor</th>
        <th class="px-6 py-3 text-left text-sm font-medium text-white">Estado</th>
