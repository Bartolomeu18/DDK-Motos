...
<nav class="p-6 space-y-4 text-sm font-medium text-gray-700 flex flex-col gap-5">
    ...
    <i class="fa-solid fa-house" style="color: #ff0000;"></i> <p>Dashboard</p>
            ...
            <!-- Gestão de Admin -->
    <a href="{{route('Admin.show')}}" class=" hover:text-red-600 text-md font-bold flex items-center gap-3 align-center space-around">
        <i class="fa-solid fa-plus" style="color: #ff0606;"></i><p> Add Admin</p>
    </a>

        <!-- Gestão de Agentes -->
    <a href="{{route('dashboard')}}" class=" hover:text-red-600 text-md font-bold flex items-center gap-3 align-center space-around">
        <i class="fa-solid fa-plus" style="color: #ff0606;"></i><p> Add Agente</p>
    </a>

    <!-- Gestão de Motoqueiros -->
    <a href="{{route('motoqueiros.index')}}" class=" hover:text-red-600 text-md font-bold flex items-center gap-3 align-center space-around">
