    ...
    <div class="overflow-x-auto bg-white shadow rounded-lg">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-100">
                <tr>
                   <th class="px-6 py-3 text-left text-sm font-medium text-gray-700">ID Moto</th>
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($dados as $dado)
                    <tr>
                      <td class="px-6 py-4">{{$dado['moto_id']}}</td>
                       <td class="px-6 py-4">{{$dado['nome']}}</td>
                        <td class="px-6 py-4 capitalize"> {{$dado['data']}} </td>
                        <td class="px-6 py-4 capitalize">{{$dado['horaChegada'] }}</td>
                  </tr>
                @empty
                    <tr>
