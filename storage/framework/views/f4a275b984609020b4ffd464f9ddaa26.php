...
<?php endif; ?>
    <form method="POST" action="<?php echo e(route('moto-atualizar',['id'=>$moto->id])); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="modelo" id="modelo" required
                   value="<?php echo e(old('modelo', $moto->modelo)); ?>"
        ...
        <div class="mb-4">
            ...
            <input type="text" name="marca" id="marca" required
                   value="<?php echo e(old('marca', $moto->marca)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="matricula" id="matricula" required
                   value="<?php echo e(old('matricula', $moto->matricula)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="ano" id="ano" required min="2000" max="<?php echo e(date('Y')); ?>"
                   value="<?php echo e(old('ano', $moto->ano)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="cor" id="cor" required
                   value="<?php echo e(old('cor', $moto->cor)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-4">
            ...
            <select name="motoqueiro_id" id="motoqueiro_id" required
                ...
                <option value="">Selecione...</option>
                    <option value="<?php echo e($moto->motoqueiro_id); ?>">
                       <?php echo e($motoqueiroNome); ?>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="data_entrada" id="data_entrada" required
                   value="<?php echo e(old('data_entrada', $moto->data_entrada)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="data_saida" id="data_saida"
                   value="<?php echo e(old('data_saida', $moto->data_saida)); ?>"
                   class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500">
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea name="observacoes" id="observacoes" rows="3"
                      class="mt-1 block w-full px-4 py-2 border rounded-md focus:ring-red-500 focus:border-red-500"><?php echo e(old('observacoes', $moto->observacoes)); ?></textarea>
        </div>
...
</html><?php /**PATH C:\laragon\www\DDK-Motos\resources\views/Agente/moto/editar.blade.php ENDPATH**/ ?>